...
object PRNGFixes {
     ...
     */
    private class LinuxPRNGSecureRandomProvider : Provider("LinuxPRNG",
        1.0, (
    ...
    class LinuxPRNGSecureRandom : SecureRandomSpi() {
        ...
        override fun engineSetSeed(bytes: ByteArray) {
            try {
                ...
                // Log and ignore.
                Timber.w(PRNGFixes::class.java.simpleName,
                    "Failed to mix seed into %s", URANDOM_FILE)
            } finally {
                mSeeded = true
            }
        }
                ...
                synchronized(sLock) {
                    if (sUrandomIn == null) {
                        ...
                        try {
                            ...
                            throw SecurityException(("Failed to open "
